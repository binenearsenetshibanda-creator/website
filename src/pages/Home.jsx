  ...
  return (
    <section className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-[var(--color-royal)] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[var(--color-royal-light)]"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-900 transition hover:border-[var(--color-royal)] hover:text-[var(--color-royal)]"
              >
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <article className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-soft transition hover:-translate-y-1 hover:shadow-lg">
        ...
        <article className="rounded-[28px] border border-[rgba(29,78,216,0.16)] bg-white p-6 shadow-[0_20px_60px_rgba(29,78,216,0.12)] transition hover:-translate-y-1 hover:shadow-lg">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-3xl bg-[var(--color-royal)]/10 text-[var(--color-royal)]">
